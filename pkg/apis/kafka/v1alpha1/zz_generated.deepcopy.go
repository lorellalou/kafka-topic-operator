...
func (in *KafkaUserAuthentication) DeepCopyInto(out *KafkaUserAuthentication) {
	*out = *in
	if in.TLS != nil {
		...
		*out = new(KafkaUserAuthenticationTLS)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaUserAuthenticationTLS) DeepCopyInto(out *KafkaUserAuthenticationTLS) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaUserAuthenticationTLS.
func (in *KafkaUserAuthenticationTLS) DeepCopy() *KafkaUserAuthenticationTLS {
	if in == nil {
		return nil
	}
	out := new(KafkaUserAuthenticationTLS)
